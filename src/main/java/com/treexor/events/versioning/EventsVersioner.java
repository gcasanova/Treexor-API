package com.treexor.events.versioning;
...
@Service
public class EventsVersioner implements Versioner {

    @Value("${entity.event.version}")
    ...
    @Autowired
    public EventsVersioner(LockManager lock) {
